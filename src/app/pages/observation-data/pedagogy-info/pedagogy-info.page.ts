...
@Component({
  ...
  templateUrl: './pedagogy-info.page.html',
  styleUrls: ['./pedagogy-info.page.scss'],
})
export class PedagogyInfoPage implements OnInit {
  ques:any;
  quesValue:any;
  extra_field:any=[];
  extra_img:any=[]
...
this.curr_template=temp.questions.filter(val=>val.section == "2")
  ...
  if(this.last_saved_data){
    // console.log("d",this.last_saved_data)
...
//NO USE
// setValuefor_Sub_field(value){
//   const pedagogy_info: any = <FormArray>this.questionForm.controls['pedagogy_info'];
//   pedagogy_info.patchValue(this.last_saved_data.pedagogy_info);
//   // if(value.length >0){
//   // value.forEach((res,index)=>{
//   //   if(res.sub_field_array.length >0){
    
//   //     res.sub_field_array.forEach((res_sub,index_sub)=>{
//   //       // pedagogy_info.controls[index].addControl('sub_field_array',this.fb.array([]))
//   //       // pedagogy_info.controls[index].get('sub_field_array').controls[index_sub].controls.ans.setValue(res_sub.ans)
//   //       console.log("sc",(<FormArray> this.questionForm.controls['pedagogy_info']).at(index).get('sub_field_array') as FormArray )
//   //       // let parent=(<FormArray> this.questionForm.controls['pedagogy_info']).at(index)
//   //       // let child=parent.get('sub_field_array') as FormArray
//   //       // console.log(child) 
//   //     })
//   //   }
//   // })
...
//   }
  ...
  onSubmit(){
    ...
    // if(records.hasOwnProperty('tntp_content')){
    //   records.pedagogy_info=records.records['tntp_content']
    //   delete records.tntp_content;
    // }
   records.pedagogy_info.forEach(res=>{
    ...
    // records.tntp_content=records.pedagogy_info
    // delete records.pedagogy_info
...
valueChanges(event,name,i){
  ...
  if(value.length>0){
    ...
    //  sub_field_template
     ...
     control.controls[i].addControl('sub_field_array',this.fb.array([]))
     const pedagogy_info: any = <FormArray>this.questionForm.controls['pedagogy_info'];
     console.log("adcc",pedagogy_info.controls[0].get('sub_field_array') as FormArray)
